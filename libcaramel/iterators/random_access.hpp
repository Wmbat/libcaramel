...
namespace crl
{
   ...
   public:
      ...
      using value_type = typename std::iterator_traits<PointerType>::value_type;
      using difference_type = typename std::iterator_traits<PointerType>::difference_type;
      using reference = typename std::iterator_traits<PointerType>::reference;
      using pointer = typename std::iterator_traits<PointerType>::pointer;
   ...
   public:
       ...
       */
      constexpr explicit random_access_iterator(PointerType p_value) : mp_value{p_value} {}

      template <typename Iter>
      constexpr random_access_iterator(const random_access_iterator<Iter>& other) :
